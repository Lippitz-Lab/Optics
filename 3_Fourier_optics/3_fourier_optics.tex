...
\ziel{Ich kann das Filtern von Raumfrequenzen experimentell \wort{demonstrieren} und \wort{erklären}.}



%-----------------------------------------------------------------------------
\section{Beugung im reziproken Raum}
\ziel{Ich kann Beugung im Fourier-Formalismus \wort{erklären}.}

\begin{itemize}

\item {Raumfrequenzen einer Blende}

\item {Fresnel- und Fraunhofer-Näherung}

\end{itemize}

\lit{Saleh/Teich  Kap. 4, Hecht Kap.11}



%-----------------------------------------------------------------------------
\section{Beugungsbegrenzung}
\ziel{Ich kann das Auflösungsvermögen eines Mikroskops und den Raumfilter im Formalismus der Fourier-Optik \wort{erklären}.}

\begin{itemize}

\item {Fourier-Transformation mittels Linse}

\item {Gauß-Strahl an sich selbst gebeugt}
\end{itemize}
...
%-----------------------------------------------------------------------------
\section{Bonus: Optische Datenverarbeitung}
\ziel{Ich kann optischen Mustererkennung im Formalismus der Fourier-Optik \wort{erklären}.}
...
\ziel{Ich kann einen Raumfilter (engl. pin hole) für Gauß-Strahlen \wort{justieren}.}
