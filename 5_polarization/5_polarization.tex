\renewcommand{\lastmod}{December 8, 2023}
...
\begin{figure}
    \inputtikz{\currfiledir uniaxial_crystals}
    \caption{Ordinary ($n_o$) and extraordinary ($n_{eo}$) index of refraction for quartz (\ch{SiO2}) and calcite (\ch{CaCO3}). As for quartz, $n_{eo} > n_0$, quartz is called positive-uniaxial, while calcite is negative-uniaxial.}
\end{figure}
...
\begin{marginfigure}
    \inputtikz{\currfiledir k-surface}
...
\begin{figure}
    \inputtikz{\currfiledir k-surface_wavefronts}
...
\begin{figure}
    \inputtikz{\currfiledir birefringence}
